...
public class AuthenticatedToolListAllTest extends TestHarness {

	// Test cases -------------------------------------------------------------

	@ParameterizedTest
	@CsvFileSource(resources = "/authenticated/item/list-all-tools.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
